...
public class Jackson1DeserializerTest {
    ...
    public void testFromString_std_safe() throws Exception {
        Jackson1SamplePojo result = instance.fromString(true, JSONString.SAMPLE_POJO, Jackson1SamplePojo.class);
    ...
    public void testFromString_std_unsafe() throws Exception {
        Jackson1SamplePojo result = instance.fromString(false, JSONString.SAMPLE_POJO, Jackson1SamplePojo.class);
        Assert.assertTrue(result.getBooleanValue());
        Assert.assertEquals(123, result.getInteger(), 0);
        Assert.assertEquals("File Mock", result.getString());
        Assert.assertNotNull(result.getSubObject());
    ...
    public void testFromString_missing_safe() throws Exception {
        Jackson1SamplePojo result = instance.fromString(true, JSONString.SAMPLE_POJO_MISSING, Jackson1SamplePojo.class);
        Assert.assertTrue(result.getBooleanValue());
        Assert.assertEquals(123, result.getInteger(), 0);
        Assert.assertEquals("File Mock", result.getString());
        Assert.assertNotNull(result.getSubObject());
    ...
    public void testFromString_missing_unsafe() throws Exception {
        Jackson1SamplePojo result = instance.fromString(false, JSONString.SAMPLE_POJO_MISSING, Jackson1SamplePojo.class);
        Assert.assertTrue(result.getBooleanValue());
        Assert.assertEquals(123, result.getInteger(), 0);
        Assert.assertEquals("File Mock", result.getString());
        Assert.assertNotNull(result.getSubObject());
    ...
    public void testFromString_more_safe() throws Exception {
        Jackson1SamplePojo result = instance.fromString(true, JSONString.SAMPLE_POJO_MORE, Jackson1SamplePojo.class);
        Assert.assertTrue(result.getBooleanValue());
        Assert.assertEquals(123, result.getInteger(), 0);
        Assert.assertEquals("File Mock", result.getString());
        Assert.assertNotNull(result.getSubObject());
    ...
    public void testFromString_more_unsafe() throws Exception {
        Jackson1SamplePojo result = instance.fromString(false, JSONString.SAMPLE_POJO_MORE, Jackson1SamplePojo.class);
    }
    ...
    public void testFromString_error_safe() throws Exception {
        Jackson1SamplePojo result = instance.fromString(true, JSONString.SAMPLE_POJO_ERROR, Jackson1SamplePojo.class);
    }
    ...
    public void testFromString_error_unsafe() throws Exception {
        Jackson1SamplePojo result = instance.fromString(false, JSONString.SAMPLE_POJO_ERROR, Jackson1SamplePojo.class);
    }
