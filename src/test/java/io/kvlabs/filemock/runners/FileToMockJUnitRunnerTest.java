...
import io.kvlabs.filemock.anotation.MockFromFile;
...
public class FileToMockJUnitRunnerTest {
    ...
    @MockFromFile(path = "/META-INF/mock/sample_pojo_more.json")
    Jackson1SamplePojo jackson1SamplePojo;

    @MockFromFile(path = "/META-INF/mock/sample_pojo_missing.json", safeMode = false)
    Jackson1SamplePojo jackson1SamplePojo2;

    @MockFromFile(path = "/META-INF/mock/sample_pojo_more.json", mapper = Mapper.JACKSON_2)
    Jackson2SamplePojo jackson2SamplePojo;

    @MockFromFile(path = "/META-INF/mock/sample_pojo.json", safeMode = false, mapper = Mapper.JACKSON_2)
    Jackson2SamplePojo jackson2SamplePojo2;

    @MockFromFile(path = "/META-INF/mock/sample_pojo.json", mapper = Mapper.GSON)
    GsonSamplePojo gsonPojo;

    @MockFromFile(path = "/META-INF/mock/sample_pojo.json", mapper = Mapper.MOSHI)
