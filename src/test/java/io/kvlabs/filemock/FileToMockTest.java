...
import test.kvlabs.filemock.model.jackson1.Jackson1SamplePojo;
import test.kvlabs.filemock.model.jackson2.Jackson2SamplePojo;
...
public class FileToMockTest {
    ...
    public void testMock_default_jackson1() {
        Jackson1SamplePojo result = FileToMock.mockFile(SAMPLE_POJO_MORE, Jackson1SamplePojo.class);
        //--
    ...
    public void testMock_mapper_jackson1() {
        Jackson1SamplePojo result = FileToMock.mockFile(SAMPLE_POJO_MORE, Mapper.JACKSON_1, Jackson1SamplePojo.class);
        //--
        Assert.assertTrue(result.getBooleanValue());
        Assert.assertEquals(123, result.getInteger(), 0);
        Assert.assertEquals("File Mock", result.getString());
    ...
    public void testMock_unsafe_jackson1() {
        Jackson1SamplePojo result = FileToMock.mockFile(SAMPLE_POJO_MORE, Mapper.JACKSON_1, true, Jackson1SamplePojo.class);
        //--
        Assert.assertEquals(123, result.getInteger(), 0);
        Assert.assertEquals("File Mock", result.getString());
        Assert.assertNotNull(result.getSubObject());
     ...
     * Test of mock method, of class FileToMock.
     */
    @Test(expected = io.kvlabs.filemock.exception.JsonMappingException.class)
    public void testMock_unsafe_jackson1_more() {
        Jackson1SamplePojo result = FileToMock.mockFile(SAMPLE_POJO_MORE, Mapper.JACKSON_1, false, Jackson1SamplePojo.class);
    }
    ...
    public void testMock_safe_jackson2() {
        Jackson2SamplePojo result = FileToMock.mockFile(SAMPLE_POJO_MISSING, Mapper.JACKSON_2, true, Jackson2SamplePojo.class);
    ...
    public void testMock_safe_gson() {
        GsonSamplePojo result = FileToMock.mockFile(SAMPLE_POJO, Mapper.GSON, true, GsonSamplePojo.class);
        //--
        Assert.assertTrue(result.getBooleanValue());
        Assert.assertEquals(123, result.getInteger(), 0);
        Assert.assertEquals("File Mock", result.getString());
    ...
    public void testMock_safe_moshi() {
        MoshiSamplePojo result = FileToMock.mockFile(SAMPLE_POJO, Mapper.MOSHI, true, MoshiSamplePojo.class);
        //--
        Assert.assertTrue(result.getBooleanValue());
        Assert.assertEquals(123, result.getInteger(), 0);
        Assert.assertEquals("File Mock", result.getString());
